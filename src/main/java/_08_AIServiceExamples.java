...
public class _08_AIServiceExamples {
    ...
    static class AI_Service_with_System_and_User_Messages_Example {
        ...
        public static void main(String[] args) {
            ...
            String translation = utils.translate("Hello, how are you?", "Arabic");
    ...
    static class ServiceWithMemoryExample {
        ...
        public static void main(String[] args) {
            ...
            System.out.println(answer); // Hello Mahmoud! How can I assist you today?

            String answerWithName = assistant.chat("What is my name?");
            System.out.println(answerWithName); // Your name is Mahmoud.
        }
    }
    ...
    static class ServiceWithMemoryForEachUserExample {
        ...
        public static void main(String[] args) {
            ...
            // Hi Mahmoud! How can I assist you today?

            System.out.println(assistant.chat(2, "Hello, my name is Esmat"));
            // Hello Esmat! How can I assist you today?
